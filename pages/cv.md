...
{:.text-center}
[CV (english)]({{ site.url }}/files/CV_Tiphaine_Viard.pdf) \| [Publications]({{ site.url }}/about/publications/) \| [ORCID profile](https://orcid.org/{{ site.owner.orcid }}) \| [Google Scholar profile](https://scholar.google.com/citations?user={{ site.owner.gscholar }}&hl=en) 

<!-- Alternaetly, user html5 embed tag -->
<iframe src="{{ site.url }}/files/CV_Tiphaine_Viard.pdf" width="100%" style="height: 100vh;"></iframe>
